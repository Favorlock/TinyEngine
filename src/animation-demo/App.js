...
window.onload = function () {
    ...
    assetManager.queueDownload('raptor.victory', '../../assets/raptor/Victory.png');
    assetManager.downloadAll(function () {
        ...
        let raptorVictoryFrames = ImageUtils.sliceImage(assetManager.cache['raptor.victory'], 30, 51);
        ...
        raptor = new Entity();
        trans = new TransformComponent((xOffset += interval) + 25,
            ctx.canvas.height / 3 + 100,
            3, 3, 0);
        raptor.add(trans);
        raptor.add(new AnimatorComponent(new Animation(raptorVictoryFrames, 100 / 1000, true)));
